module.exports = {
  ...
  maxDecimals2: {
    rule: 'matchRegexp:^[0-9]*\.[0-9]{0,2}$', // eslint-disable-line no-useless-escape
    message: 'this field must contain a number with up to 2 decimal spaces',
  },
  url: {
    rule: 'matchRegexp:(https?:\/\/(?:www\.|(?!www))[a-zA-Z0-9][a-zA-Z0-9-]+[a-zA-Z0-9]\.[^\s]{2,}|www\.[a-zA-Z0-9][a-zA-Z0-9-]+[a-zA-Z0-9]\.[^\s]{2,}|https?:\/\/(?:www\.|(?!www))[a-zA-Z0-9]+\.[^\s]{2,}|www\.[a-zA-Z0-9]+\.[^\s]{2,})', // eslint-disable-line no-useless-escape
