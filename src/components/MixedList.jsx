...
export default function MixedList({ search = '' }) {
    ...
    const favourite = useCallback((_id) => {
        //TODO: update to db
    ...
    return <div className='flex flex-wrap justify-center'>
        {filteredList.art.map((art) => <Art {...art} key={art._id} onFavourite={favourite} />)}
        {filteredList.jewelry.map((jewelry) => <Jewelry {...jewelry} key={jewelry._id} onFavourite={favourite} />)}
    </div>
}