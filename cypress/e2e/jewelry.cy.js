describe('jewelry test', () => {
    ...
    it('edit created jewelry', () => { 
        ...
        cy.get('[data-cy=jewelry_edit_name_input]').type('editedName');
        cy.get('[data-cy=jewelry_edit_url_input]').type('http://localhost:3000/images/jewelry/colour_changing_pendant.jpg');
        cy.get('[data-cy=jewelry_edit_price_input]').type('159.99');
        cy.get('[data-cy=jewelry_edit_category_input]').type('editedCategory');
        cy.get('[data-cy=jewelry_edit_material_input]').type('editedMaterial');
        cy.get('[data-cy=jewelry_edit_colour_input]').type('editedColour');
